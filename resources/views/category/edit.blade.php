...
@section('content')
    <div class="container mx-auto">
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <form action="{{ route('category.update', [$tag_updated->id]) }}" method="POST">
                @csrf
                @method('PUT')
                @if ($errors->any())
                ...
                <div class="mt-1">
                    <input type="text" name="name" id="name"
                        ...
                        placeholder="Enter Category Name" value="{{ old('name', $tag_updated->name) }}">
                </div>
        ...
        <hr class="mt-5 mb-4">
        @if (count($tags) > 0)
            <h3 class="text-center mb-4" style="font-size: 24px">Category Lists</h3>
            <hr>
                    ...
                    <div class="col lg:w-1/3 lg:pr-4">
                        <div class="bg-white shadow-md rounded-md p-4 m-2 max-w-xs">
                            ...
                            <div class="flex justify-end">
                                <a href="{{ route('category.edit', $tag->id) }}"
